...
if (clientID<0)
    ...
    [res,Vision_sensor] = vrep.simxGetObjectHandle(clientID,'Vision_sensor',vrep.simx_opmode_blocking);%增加图像传感器
    %初始化一些变量
    ...
    while toc<30
        ...
        [res,resolution,image]= vrep.simxGetVisionSensorImage2(clientID,Vision_sensor,0,vrep.simx_opmode_buffer);%接收图像传感器数据
